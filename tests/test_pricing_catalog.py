...
class PricingCatalogTests(unittest.TestCase):
    ...
    def test_model_management_ui_contract(self):
        ...
        self.assertIn('.section-heading h2 span:last-child { font-size:12px;', css_source)
        ...
        self.assertIn(".scenario-result-scroll { min-width:0; overflow-y:auto;", css_source)
        self.assertIn(".tool-view-body { min-width:0; min-height:0; overflow-x:hidden; overflow-y:auto; }", css_source)
        self.assertIn(".scenario-row-inputs { min-width:0; display:grid; grid-template-columns:1fr; }", css_source)
        ...
        self.assertIn(".scenario-entry-list { width:max-content; min-width:0; display:grid; grid-auto-flow:column; grid-auto-columns:180px;", css_source)
        self.assertIn("grid-template-columns:repeat(2, minmax(0, 1fr))", css_source)
        self.assertIn("section-heading h2 span:last-child { display:inline;", css_source)
